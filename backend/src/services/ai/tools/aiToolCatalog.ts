import type { AiToolDefinition } from '../../../contracts/aiToolDto.js'
import { TOOL_CATEGORY, TOOL_PERMISSION } from '../../../contracts/aiToolDto.js'

/** Sync with shared/ai-tool-engine/catalog.js */
export const AI_TOOL_CATALOG: AiToolDefinition[] = [
  ...
  },
  {
    ...
    parameters: {
      type: 'object',
      properties: { orderId: { type: 'string' }, planNote: { type: 'string' } },
  ...
  },
  {
    ...
    parameters: {
      type: 'object',
      properties: { orderId: { type: 'string' }, resolution: { type: 'string' } },
  ...
  },
  {
    ...
    parameters: {
      type: 'object',
      properties: { orderId: { type: 'string' }, supplierId: { type: 'string' } },
      required: ['orderId'],
    },
  },
  {
...
export function listToolsForWorker(workerId: string): AiToolDefinition[] {
  return AI_TOOL_CATALOG.filter((t) => t.workerIds.includes(workerId))
}

export function getToolMeta(name: string): AiToolDefinition | null {
