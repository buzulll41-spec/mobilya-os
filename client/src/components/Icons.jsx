...
export function IconDashboard() {
  return (
    <svg className="mos-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <path d="M4 13h6V4H4v9zm10 7h6v-7h-6v7zM4 21h6v-5H4v5zm10-9h6V4h-6v8z" />
    </svg>
  )
}
...
export function IconTruck() {
  return (
    <svg className="mos-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <path d="M1 3h15v13H1zM16 8h4l3 3v5h-7V8zM5 21a2 2 0 100-4 2 2 0 000 4zm10 0a2 2 0 100-4 2 2 0 000 4z" />
    </svg>
  )
}
...
export function IconWallet() {
  return (
    <svg className="mos-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      ...
      <path d="M3 7h14a2 2 0 012 2v1H3V7z" />
