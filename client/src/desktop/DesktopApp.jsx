...
export default function App() {
  ...
  const immersivePhoneHome = viewportTier === 'phone' && page === 'dashboard'
  ...
  const hasPersistedSession = Boolean(loadAuthSession())
  const suppressMobileDashboardError = viewportTier === 'phone' && page === 'dashboard'
  ...
  if (requiresLogin || (!apiMode && !hasPersistedSession)) {
  ...
  return (
    <>
      ...
      >
        ...
        {!immersivePhoneHome ? <OfflineBanner /> : null}
        ...
        {error && !suppressMobileDashboardError ? (
        ...
        {!immersivePhoneHome && !loading && pendingPaymentApprovalCount > 0 ? (
